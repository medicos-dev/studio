...
const StyledWrapper = styled.div`
  ...
  .icon-2 {
    ...
    animation: slay-2-normal 3s cubic-bezier(0.52, 0, 0.58, 1) 1s infinite;
  }
  ...
  .icon-3 {
    ...
    transition: all 1s ease-in-out;
    filter: drop-shadow(2px 2px 3px rgba(0, 0, 0, 0.5));
    animation: slay-3-normal 2s cubic-bezier(0.52, 0, 0.58, 1) 1s infinite;
  }

  ...
  return (
    <section className="relative min-h-[calc(100svh-5rem)] md:h-screen flex items-center justify-center text-center overflow-hidden bg-background py-8 md:py-0">
      ...
      <div className="relative z-10 container mx-auto px-4">
        <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter !leading-[1.1] font-headline">
          Asterasia
        </h1>
        <p className="mt-3 md:mt-4 text-lg md:text-2xl text-muted-foreground max-w-2xl mx-auto px-2">
